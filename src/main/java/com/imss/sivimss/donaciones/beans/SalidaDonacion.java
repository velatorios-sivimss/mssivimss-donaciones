...
public class SalidaDonacion {
	...
	public DatosRequest detalleSalidaAtaudDonado(DatosRequest request, UsuarioDto usuarioDto) {
		...
		.innerJoin("SVT_ARTICULO A", "S.ID_ARTICULO = A.ID_ARTICULO").and("S.ID_TIPO_ASIGNACION_ART = 3").and("S.IND_ESTATUS = 0").and("A.IND_ACTIVO = 1")
	...
	public InsertMultiNivelRequest insertPersona(DonacionRequest donacionRequest, UsuarioDto usuarioDto) {
		...
		q.agregarParametroValues("REF_OTRO_SEXO", SelectQueryUtil.setValor(donacionRequest.getDesOtroSexo()));
		...
		q.agregarParametroValues("REF_TELEFONO",  SelectQueryUtil.setValor(donacionRequest.getDesTelefono()));
		q.agregarParametroValues("REF_CORREO", SelectQueryUtil.setValor( donacionRequest.getDesCorreo()));
	...
	public String insertDomicilio(DonacionRequest donacionRequest, UsuarioDto usuarioDto) {
		...
		q.agregarParametroValues("REF_CALLE", SelectQueryUtil.setValor(donacionRequest.getDesCalle()));
		...
		q.agregarParametroValues("REF_CP", String.valueOf(donacionRequest.getDesCodigoPostal()));
		q.agregarParametroValues("REF_COLONIA", SelectQueryUtil.setValor(donacionRequest.getDesColonia()));
		q.agregarParametroValues("REF_MUNICIPIO", SelectQueryUtil.setValor(donacionRequest.getDesMunicipio()));
		q.agregarParametroValues("REF_ESTADO", SelectQueryUtil.setValor(donacionRequest.getDesEstado()));
		q.agregarParametroValues(ConsultaConstantes.ID_USUARIO_ALTA, String.valueOf(usuarioDto.getIdUsuario()));
		q.agregarParametroValues(ConsultaConstantes.FEC_ALTA, ConsultaConstantes.CURRENT_DATE);
	...
	public String insertSalidaDonacion(DonacionRequest donacionRequest, UsuarioDto usuarioDto) {
		...
		q.agregarParametroValues("REF_INSTITUCION", SelectQueryUtil.setValor(donacionRequest.getNomInstitucion()));
		...
		q.agregarParametroValues("NOM_RESPONSABLE_ALMACEN", SelectQueryUtil.setValor(SelectQueryUtil.eliminarEspacios(donacionRequest.getResponsableAlmacen())));
	...
	public ActualizarMultiRequest actualizarSalidaDonacionPrincipal(DonacionRequest donacionRequest, UsuarioDto usuarioDto) {
		...
		if (donacionRequest.getIdContratante() != null) {
			...
			q1.agregarParametroValues("REF_CALLE", SelectQueryUtil.setValor( donacionRequest.getDesCalle()));
			...
			q1.agregarParametroValues("REF_CP", String.valueOf(donacionRequest.getDesCodigoPostal()));
			q1.agregarParametroValues("REF_COLONIA", SelectQueryUtil.setValor(donacionRequest.getDesColonia()));
			q1.agregarParametroValues("REF_MUNICIPIO", SelectQueryUtil.setValor(donacionRequest.getDesMunicipio()));
			q1.agregarParametroValues("REF_ESTADO", SelectQueryUtil.setValor(donacionRequest.getDesEstado()));
